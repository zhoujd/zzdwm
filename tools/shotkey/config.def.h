...
Key keys[] = {
  ...
  { MODKEY|ControlMask,           XK_w,          cmd("dmenu_wincd &") },
  { MODKEY|ControlMask|ShiftMask, XK_w,          cmd("dmenu_wincd &") },
  ...
  { MODKEY|Mod1Mask,              XK_y,          cmd("dmenu_date &") },
  { MODKEY|ControlMask,           XK_y,          cmd("deckwin &") },
  { MODKEY|ControlMask|ShiftMask, XK_y,          cmd("movewin &") },
