//----------------------------------------------------------------
//	liveview.cpp	(An enhancement of our 'fileview.cpp')
//
...
//
//         compile-and-link using: $ make liveview
//
//	programmer: ALLAN CRUSE
//	written on: 26 OCT 2002
//	revised on: 07 JUN 2006 -- removed reliance on 'ncurses'
//	revised on: 07 JUN 2007 -- view gets continually updated
//	revised on: 29 OCT 2007 -- to hide cursor during redraws
//----------------------------------------------------------------
...
int main( int argc, char *argv[] )
{
  ...
  tty_work.c_cc[ VMIN ]  = 0;	// <--- for 'live' view
  ...
  while ( !done )
    ...
    long long	inch = 0LL;
    if ( read( STDIN_FILENO, &inch, sizeof( inch ) ) > 0 )
