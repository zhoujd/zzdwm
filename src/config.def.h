...
static const unsigned int minwsz    = 25;       /* tile: minimal stack heigt */
static const unsigned int mincellw  = 50;       /* grid: minimal cell width */
static const unsigned int mincellh  = 50;       /* grid: minimal cell heigt */
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_v,      spawn,            {.v = nextwincmd} },
	{ MODKEY|ShiftMask,             XK_v,      spawn,            {.v = prevwincmd} },
