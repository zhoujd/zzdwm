...
static const char *runeccmd[] = { "runec", NULL };
...
static const char *movewincmd[] = { "movewin", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_c,            spawn,            {.v = movewincmd} },
	{ MODKEY|ControlMask|ShiftMask, XK_c,            spawn,            {.v = deckwincmd} },
	{ MODKEY,                       XK_e,            spawn,            {.v = runeccmd} },
	...
	{ MODKEY|Mod1Mask,              XK_i,            spawn,            {.v = infomenucmd} },
