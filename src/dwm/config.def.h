...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask|ShiftMask, XK_c,      spawn,            {.v = prevtermcmd} },
	{ MODKEY,                       XK_e,      spawn,            {.v = emacscmd} },
	{ MODKEY|Mod1Mask,              XK_e,      spawn,            {.v = pullemacscmd} },
	{ MODKEY|ControlMask,           XK_e,      spawn,            {.v = nextemacscmd} },
	{ MODKEY|ControlMask|ShiftMask, XK_e,      spawn,            {.v = prevemacscmd} },
	...
	{ MODKEY|ControlMask|ShiftMask, XK_x,      killclient,       {.ui = 2} },
